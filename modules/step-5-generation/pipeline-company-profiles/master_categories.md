...
> Reference document for content-analyzer. Use these categories to classify companies.
> When a company fits a category, use the exact slug. If no category fits, suggest a new one.

## Classification Rules

- **Primary** = core business model / main revenue driver. A company typically has 1-2 primary categories.
...
- Tags are separate from categories — tags capture specific features/USPs (≤3 words each).
...
### operator — Operator
An iGaming operator is a company licensed to provide online gambling services to the public. These businesses manage the entire operation including player acquisition, payments, and compliance. They typically aggregate content from various suppliers to build a comprehensive entertainment product, acting as the B2C face of the industry.
