...
**Categories are a fixed taxonomy.** The analyzer assigns only from master_categories.md. It does NOT suggest new categories. A category with only one company serves no directory purpose.

**Tags can be suggested.** If the analyzer identifies a USP or differentiator not covered by existing tags, it may suggest new tags. These are flagged as `"status": "suggested_new"` so they're visible for editorial review.
...
- `tags_preview` — comma-joined tag slugs
- `facts_preview` — human-readable key facts summary
...
```json
{
  "categories": {
    "primary": [
      {"slug": "fraud-prevention", "why": "Core product Gatekeeper is a fraud detection platform", "source": "https://bespot.com/about"}
    ],
    "secondary": [
      {"slug": "kyc-services", "why": "Location verification contributes to KYC workflows", "source": "https://bespot.com/products"},
      {"slug": "aml-solutions", "why": "Location data flags suspicious geographic patterns", "source": "https://bespot.com/products"},
      {"slug": "compliance-and-regulatory", "why": "GLI certification and multi-jurisdiction privacy compliance", "source": "https://bespot.com/press/gli"}
    ]
  },
  "tags": {
    "existing": [
      {"slug": "ai-powered", "why": "EGR B2B Awards shortlist in AI Solutions Supplier category"},
      {"slug": "gdpr-compliant", "why": "Privacy policy confirms GDPR, CPRA, LGPD compliance"},
      {"slug": "real-time-monitoring", "why": "Continuous session verification, not just login check"},
      {"slug": "api-integration", "why": "API-based integration for operators"},
      {"slug": "sdk", "why": "SDK for mobile app integration"},
      {"slug": "geofencing", "why": "Geographic boundary enforcement for operators"}
    ],
    "suggested_new": [
      {"label": "clone-app-detection", "why": "Unique USP — detects fraudulent app copies", "evidence": ["https://bespot.com/gatekeeper"]},
      {"label": "gps-spoofing-detection", "why": "Core fraud prevention capability", "evidence": ["https://bespot.com/gatekeeper"]},
      {"label": "gli-certified", "why": "Independent certification differentiator", "evidence": ["https://bespot.com/press/gli"]}
    ]
  },
  "key_facts": {
    "founded": null,
    ...
    "employees": null,
    "key_people": [
      {"name": "Spiros Tassis", "role": "Data Protection Officer", "source": "https://bespot.com/privacy"}
    ],
    "licenses": [
      {"detail": "GLI Control Assessment — Blueprint and Gatekeeper solutions", "source": "https://bespot.com/press/gli"}
    ],
    "awards": [
      {"detail": "EGR B2B Awards 2025 — AI Solutions Supplier (shortlisted)", "source": "https://egr.global/b2b-awards-2025"},
      {"detail": "EGR B2B Awards 2025 — Compliance & KYC Supplier (shortlisted)", "source": "https://egr.global/b2b-awards-2025"},
      {"detail": "SBC Awards Latinoamerica 2024 — Rising Star in Sports Betting (shortlisted)", "source": "https://sbc.events/awards"}
    ],
    "partnerships": [
      {"detail": "Gaming Laboratories International (GLI) — certification partner", "source": "https://bespot.com/press/gli"}
    ],
    "offices": ["Athens, Greece"],
    "contact": {
      "email": null,
      "phone": null,
      "website": "https://bespot.com"
    }
  },
  "source_citations": [
    {"index": 1, "url": "https://bespot.com/about", "title": "About Bespot"},
    {"index": 2, "url": "https://bespot.com/press/gli", "title": "GLI Certification Announcement"},
    {"index": 3, "url": "https://egr.global/b2b-awards-2025", "title": "EGR B2B Awards 2025"}
  ]
}
```
...
- **Fixed taxonomy means missed companies** — If a company's core business doesn't match any of the ~80 categories, it will only get secondary assignments or no categories at all. This is by design — expand the taxonomy manually rather than letting the AI create one-off categories
